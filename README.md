...
[![shipthatcode — Build a Raft KV Store](https://api.shipthatcode.com/cert/33b5107601fffe11609d5d994bc5845a.svg)](https://shipthatcode.com/courses/build-raft-kv)

My working repo for [Build a Raft KV Store](https://shipthatcode.com/courses/build-raft-kv) on [shipthatcode.com](https://shipthatcode.com) — built lesson by lesson in my own editor.
...
3. In your terminal, inside the unzipped folder, push it to GitHub:
   ...
   git init
   git add .
   git commit -m "start Build a Raft KV Store"
   git branch -M main
   git remote add origin https://github.com/YOUR-USERNAME/YOUR-REPO.git
   git push -u origin main
   ```

4. Paste your repo link on the [course page](https://shipthatcode.com/courses/build-raft-kv) ("Work in your own editor" → **Link repo**). Done — you never do this again.
